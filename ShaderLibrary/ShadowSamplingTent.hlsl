...
void SampleShadow_ComputeSamples_Tent_3x3(real4 shadowMapTexture_TexelSize, real blurSize, real2 coord, out real fetchesWeights[4], out real2 fetchesUV[4])
{
    ...
    fetchesOffsetsU *= shadowMapTexture_TexelSize.xx * blurSize;
    fetchesOffsetsV *= shadowMapTexture_TexelSize.yy * blurSize;
...
void SampleShadow_ComputeSamples_Tent_5x5(real4 shadowMapTexture_TexelSize, real blurSize, real2 coord, out real fetchesWeights[9], out real2 fetchesUV[9])
{
    ...
    fetchesOffsetsU *= shadowMapTexture_TexelSize.xxx * blurSize;
    fetchesOffsetsV *= shadowMapTexture_TexelSize.yyy * blurSize;
