...
namespace UnityEngine.Rendering.Universal
{
    ...
    class UniversalRenderPipelineCameraEditor : CameraEditor
    {
        ...
        SerializedProperty m_AdditionalCameraDataDeferredLightingProp;
        SerializedProperty m_AdditionalCameraDataHeatMapProp;
        SerializedProperty m_AdditionalCameraDataDrawClusterProp;
...
#pragma warning restore UNT0008 // Null propagation on Unity objects
        ...
        void DrawDeferredLighting()
        {
            ...
            CameraOverrideOption selectedDeferredLightingOption = (CameraOverrideOption)m_AdditionalCameraDataDeferredLightingProp.intValue;
            ...
            if (EditorGUI.EndChangeCheck())
            {
                m_AdditionalCameraDataDeferredLightingProp.intValue = (int)selectedDeferredLightingOption;
                m_AdditionalCameraDataSO.ApplyModifiedProperties();
            }
        ...
        void DrawHeatMap()
        {
            ...
            CameraOverrideOption selectedHeatMapOption = (CameraOverrideOption)m_AdditionalCameraDataHeatMapProp.intValue;

            Rect controlRectColor = EditorGUILayout.GetControlRect(true);

            EditorGUI.BeginProperty(controlRectColor, Styles.requireHeatMap, m_AdditionalCameraDataHeatMapProp);
            EditorGUI.BeginChangeCheck();

            selectedHeatMapOption = (CameraOverrideOption)EditorGUI.IntPopup(controlRectColor, Styles.requireHeatMap, (int)selectedHeatMapOption, Styles.displayedAdditionalDataOptions, Styles.additionalDataOptions);

            if (EditorGUI.EndChangeCheck())
            {
                m_AdditionalCameraDataHeatMapProp.intValue = (int)selectedHeatMapOption;
                m_AdditionalCameraDataSO.ApplyModifiedProperties();
            }
        ...
        void DrawDrawCluster()
        {
            m_AdditionalCameraDataSO.Update();

            CameraOverrideOption selectedDrawClusterOption = (CameraOverrideOption)m_AdditionalCameraDataDrawClusterProp.intValue;

            Rect controlRectColor = EditorGUILayout.GetControlRect(true);

            EditorGUI.BeginProperty(controlRectColor, Styles.requireDrawCluster, m_AdditionalCameraDataDrawClusterProp);
            EditorGUI.BeginChangeCheck();

            selectedDrawClusterOption = (CameraOverrideOption)EditorGUI.IntPopup(controlRectColor, Styles.requireDrawCluster, (int)selectedDrawClusterOption, Styles.displayedAdditionalDataOptions, Styles.additionalDataOptions);

            if (EditorGUI.EndChangeCheck())
            {
                m_AdditionalCameraDataDrawClusterProp.intValue = (int)selectedDrawClusterOption;
                m_AdditionalCameraDataSO.ApplyModifiedProperties();
            }
