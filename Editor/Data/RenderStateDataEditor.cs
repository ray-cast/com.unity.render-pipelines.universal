...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class StencilStateDataDrawer : PropertyDrawer
    {
        class Styles
        {
            public static readonly GUIContent overrideStencil = new GUIContent("启用模板", "Override stencil rendering.");
            public static readonly GUIContent stencilValue = new GUIContent("Value", "The stencil index to write to.");
            public static readonly GUIContent stencilFunction = new GUIContent("Compare Function", "Choose the comparison function against the stencil value on screen.");
            public static readonly GUIContent stencilPass = new GUIContent("Pass", "What happens to the stencil value when passing.");
            public static readonly GUIContent stencilFail = new GUIContent("Fail", "What happens to the stencil value when failing.");
            public static readonly GUIContent stencilZFail = new GUIContent("Z Fail", "What happens to the stencil value when failing Z testing.");
        }
