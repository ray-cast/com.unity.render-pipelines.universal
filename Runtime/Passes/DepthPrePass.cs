namespace UnityEngine.Rendering.Universal
{
    ...
    /// </summary>
    public class DepthPrePass : ScriptableRenderPass
    {
        ...
        public DepthPrePass(RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask)
        {
            renderPassEvent = evt;

            _shaderTagId = new ShaderTagId("PrepassDepth");
