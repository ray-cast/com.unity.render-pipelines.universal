namespace UnityEngine.Rendering.Universal
{
    ...
    /// </summary>
    public class TransparentPreDepth : ScriptableRenderPass
    {
        ...
        public TransparentPreDepth(RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask)
        {
            renderPassEvent = evt;

            _shaderTagId = new ShaderTagId("TransparentPreDepth");
