namespace UnityEngine.Rendering.Universal
{
    public class GlobalSettingsPass : ScriptableRenderPass
    {
        ...
        private Vector4 _WindParams4 = Vector4.zero;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (wind.IsActive())
			{
                ...
                _WindParams4.Set(wind.lean.value, wind.angle.value, 0, 0);
                ...
                cmd.SetGlobalVector(ShaderConstants._WindParams4, _WindParams4);
            }
            else
			{
                ...
                cmd.SetGlobalVector(ShaderConstants._WindParams4, ShaderConstants.defaultWindParams4);
            }
        ...
        static class ShaderConstants
        {
            ...
            public static readonly Vector4 defaultWindParams4 = new Vector4(0, 0, 0, 0);
            ...
            public static readonly int _WindParams4 = Shader.PropertyToID("_WindParams4");
        }
    }
}