...
namespace UnityEngine.Rendering.Universal
{
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        public const int k_MaxVisibleAdditionalLightsMobile = 128;
        public const int k_MaxVisibleAdditionalLightsNonMobile = 512;
        ...
        public static float maxClusterDistance
        {
            get => 1000.0f;
        }
        ...
        public static int maxScriptableRenderers
        {
            get => 8;
        }
        ...
        {
            bool supportsCameraStacking = false;
            List<Camera> cameraStack = null;
            bool anyPostProcessingEnabled = SystemInfo.graphicsDeviceType != GraphicsDeviceType.OpenGLES2;

            if (baseCamera.TryGetComponent<UniversalAdditionalCameraData>(out var baseCameraAdditionalData))
			{
                ...
                supportsCameraStacking = renderer.supportedRenderingFeatures.cameraStacking;

                if (supportsCameraStacking)
                    cameraStack = baseCameraAdditionalData.cameraStack;

                anyPostProcessingEnabled &= baseCameraAdditionalData.renderPostProcessing;
            }
            ...
            if (cameraStack != null && cameraStack.Count > 0)
            {
                ...
                if (!IsMultiPassStereoEnabled(baseCamera))
                {
                    ...
                    for (int i = 0; i < cameraStack.Count; ++i)
                    {
                        ...
                        {
                            if (!currCamera.TryGetComponent<UniversalAdditionalCameraData>(out var data))
							{
                            ...
                            if (currCameraRendererType != baseCameraRendererType)
                            {
                                ...
                                /*var renderer2DType = typeof(UnityEngine.Experimental.Rendering.Universal.Renderer2D);
...
#pragma warning restore
        ...
        static void InitializeLightData(UniversalRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, int mainLightIndex, out LightData lightData)
        {
			...
			{
                lightData.maxLightingDistance = 0;
