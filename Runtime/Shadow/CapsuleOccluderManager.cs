...
namespace UnityEngine.Rendering.Universal
{
    public sealed class CapsuleOccluderManager
    {
        ...
        readonly Dictionary<int, List<CapsuleOccluder>> m_SortedOccluders;

        // Holds all the registered occluders
        readonly List<CapsuleOccluder> m_Occluders;
        ...
        {
            m_SortedOccluders = new Dictionary<int, List<CapsuleOccluder>>();
        ...
        List<CapsuleOccluder> GrabOccluders(LayerMask mask)
        {
            List<CapsuleOccluder> list;
