...
{ 
    public static class RenderingUtils
    {
        ...
        static Mesh s_IcosphereMesh = null;
        ...
        public static Mesh icosphereMesh
        {
            get
            {
                if (s_IcosphereMesh != null)
                    return s_IcosphereMesh;

                s_IcosphereMesh = IcoSphereCreator.Create(5, 1.02f); // 0.02 is margin
