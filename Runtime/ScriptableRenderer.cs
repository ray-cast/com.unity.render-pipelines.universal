...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract class ScriptableRenderer : IDisposable
    {
        ...
        void SetShaderTimeValues(CommandBuffer cmd, float time, float deltaTime, float smoothDeltaTime)
        {
            ...
            Vector4 frame = new Vector4(Time.frameCount, 0.0f, 0.0f, 0.0f);
            ...
            cmd.SetGlobalVector(UniversalRenderPipeline.PerFrameBuffer._Frame, frame);
        }
        ...
        void ClearRenderingState(CommandBuffer cmd)
        {
            ...
            cmd.DisableShaderKeyword(ShaderKeywordStrings.MainLightPerObjectShadow);
