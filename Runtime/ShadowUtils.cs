namespace UnityEngine.Rendering.Universal
{
    ...
    {
        private static readonly RenderTextureFormat _shadowmapFormat;
        private static readonly bool _forceShadowPointSampling;
        ...
        {
            var shadowTexture = RenderTexture.GetTemporary(width, height, bits, _shadowmapFormat);
            shadowTexture.filterMode = _forceShadowPointSampling ? FilterMode.Point : FilterMode.Bilinear;
