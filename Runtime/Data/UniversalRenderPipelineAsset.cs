...
#pragma warning restore 414
        ...
        public const string editorResourcesGUID = "a3d8d823eedde654bb4c11a1cfaf1abb";
        ...
        internal class CreateUniversalPipelineAsset : EndNameEditAction
        {
            ...
            {
                //Create asset
                AssetDatabase.CreateAsset(Create(CreateRendererAsset(pathName, RendererType.DeferredRenderer)), pathName);
            }
        }
        ...
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateUniversalPipelineAsset>(), "UniversalRenderPipelineAsset.asset", null, null);
        }
        ...
        static ScriptableRendererData CreateRendererData(RendererType type)
        {
            switch (type)
            {
                ...
                case RendererType.DeferredRenderer:
                    return CreateInstance<ClusterBasedDeferredRendererData>();
                default:
                    return CreateInstance<ForwardRendererData>();
            }
        }
        ...
        Material GetMaterial(DefaultMaterialType materialType)
        {
            ...
            switch (materialType)
            {
                case DefaultMaterialType.Universal:
        ...
        {
            get => _deferredRequireClusterHeatMap;
            set => _deferredRequireClusterHeatMap = value;
        }

        public bool requireDrawCluster
        {
            get => _deferredRequireDrawCluster;
            set => _deferredRequireDrawCluster = value;
        }

        public float maxLightingDistance
        {
            get => _deferredMaxLightingDistance;
            set => _deferredMaxLightingDistance = ValidateClusterDistance(value);
        }

        public int maxClusterLightsCount
        {
            get => _deferredLightsPerClusterLimit;
            set => _deferredLightsPerClusterLimit = ValidatePerClusterLights(value);
        }
        ...
        {
            get { return GetMaterial(DefaultMaterialType.Universal); }
        }
...
#pragma warning restore UNT0008 // Null propagation on Unity objects
        ...
        float ValidateClusterDistance(float value)
        {
            return Mathf.Max(0.0f, Mathf.Min(value, UniversalRenderPipeline.maxClusterDistance));
        }
        ...
        {
            return System.Math.Max(1, System.Math.Min(value, UniversalRenderPipeline.maxPerClusterLights));
        }
